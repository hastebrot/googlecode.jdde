 ...
 * @author Vitor Costa
 */
public class PokeEvent extends ConversationEvent<DdeServer, ServerConversation> {
	...
	public PokeEvent(DdeServer server, ServerConversation conversation,
