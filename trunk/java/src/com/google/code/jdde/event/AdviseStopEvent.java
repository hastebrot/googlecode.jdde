 ...
 * @author Vitor Costa
 */
public class AdviseStopEvent extends ConversationEvent<DdeServer, ServerConversation> {
	...
	public AdviseStopEvent(DdeServer server, ServerConversation conversation,
